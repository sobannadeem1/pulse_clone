...
const Image2 = () => {
  const title = "Monetizing a Network"; // Set a specific title for this page
  const description = "Monetizing a Network"; // Optional description
  ...
  return (
    <div className="image1-container">
      ...
      <header className="custom-header">
        <h1>
          <h1>
            Monetizing a Network: How Jodi Brandstetter Started Her Second
            Business
          </h1>
        </h1>
      </header>
