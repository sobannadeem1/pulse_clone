...
const Image5 = () => {
  const title =
    "Starting a Services Business: Tips from Writer Nicole Rollender of Strand Writing Services"; // Set a specific title for this page
  const description =
    "Starting a Services Business: Tips from Writer Nicole Rollender of Strand Writing Services"; // Optional description
  ...
  return (
    <div className="image1-container">
      ...
      <header className="custom-header">
        <h1>
          Starting a Services Business: Tips from Writer Nicole Rollender of
          Strand Writing Services
        </h1>
      </header>
