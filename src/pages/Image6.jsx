...
const Image6 = () => {
  const title =
    "Streamline Your Operations for Success: How Jonathan Saeidian Went From $2,000 to a 7-Figure Business"; // Set a specific title for this page
  const description =
    "Streamline Your Operations for Success: How Jonathan Saeidian Went From $2,000 to a 7-Figure Business"; // Optional description
  ...
  return (
    <div className="image1-container">
      ...
      <header className="custom-header">
        <h1>
          Streamline Your Operations for Success: How Jonathan Saeidian Went
          From $2,000 to a 7-Figure Business
        </h1>
      </header>
