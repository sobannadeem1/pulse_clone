...
const Image7 = () => {
  const title =
    "Balancing Your Side-Hustle and Full-Time Gig: How Greg Marano Juggles Teaching and Freelancing"; // Set a specific title for this page
  const description =
    "Balancing Your Side-Hustle and Full-Time Gig: How Greg Marano Juggles Teaching and Freelancing"; // Optional description
  ...
  return (
    <div className="image1-container">
      ...
      <header className="custom-header">
        <h1>
          Balancing Your Side-Hustle and Full-Time Gig: How Greg Marano Juggles
