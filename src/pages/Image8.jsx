...
const Image8 = () => {
  const title =
    "Big Goals and Basic Cash Flow: How Isaac Mashman Built His Top-Rated PR Firm"; // Set a specific title for this page
  const description =
    "Big Goals and Basic Cash Flow: How Isaac Mashman Built His Top-Rated PR Firm"; // Optional description
  ...
  return (
    <div className="image1-container">
      ...
      <header className="custom-header">
        <h1>
          Big Goals and Basic Cash Flow: How Isaac Mashman Built His Top-Rated
          PR Firm
        </h1>
      </header>
